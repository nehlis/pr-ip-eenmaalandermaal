...
<script type="text/javascript">
    var onloadCallback = function() {
        grecaptcha.render("html_element", {
            'sitekey': "6LevwAwaAAAAALHj3HqXlE79I2FehRFaoPM8HEVp"
        })
    };
...
<div class="signup-wrapper py-5">
    <form id="register-form" action="<?= $_SERVER['REQUEST_URI'] ?>" method="POST" class="form-signup py-5">
        ...
        <div class="row">
            <div class="col-md-6 has-signup-devider">
                ...
                <div id="html_element" data-callback="completeCallback"></div>
            </div>
        ...
        <input type="submit" id="submitForm" class="btn btn-primary mt-3 w-100" name="submit" value="Registreren" disabled />
    </form>
</div>
