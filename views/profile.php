    ...
    <div class="row">
      <div class="col-md-6 has-signup-devider">
        ...
        <div class="form-group">
          ...
          <select class="form-control" id="question">
            <?php foreach ($allQuestions as $availableQuestion) : ?>
              <option value="<?= $availableQuestion['ID']; ?>" <?= $availableQuestion === $accountQuestion ? 'selected' : null; ?>>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" value="<?= $user['QuestionAnswer'] ?? ''; ?>" name="answer" id="answer" required>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group">
          <label for="birthDate">Geboortedatum</label>
          <input type="datetime-local" class="form-control" value="<?= date("Y-m-d\TH:i:s", $formattedDate->getTimestamp()); ?>" name="birthDate" id="birthDate" required>
        </div>
        <div class="form-group">
