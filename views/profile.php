    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <input type="date" class="form-control" value="<?= date("Y-m-d", DateTime::createFromFormat('M d Y H:i:s:A', $user['Birthdate'])->getTimestamp()) ?>" name="Birthdate" id="birthDate" required>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="number" class="form-control" value="<?= $user['Housenumber'] ?? '' ?>" name="Housenumber" id="housenumber" required>
            </div>
          </div>
        </div>
